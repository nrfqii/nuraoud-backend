            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="category" id="category"
                        ...
                        <option value="Oud" {{ old('category') == 'Oud' ? 'selected' : '' }}>Oud</option>
                        <option value="Perfume" {{ old('category') == 'Perfume' ? 'selected' : '' }}>Perfume</option>
                        <option value="Attar" {{ old('category') == 'Attar' ? 'selected' : '' }}>Attar</option>
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center">
                        <input type="checkbox" name="bestseller" id="bestseller" value="1" {{ old('bestseller') ? 'checked' : '' }}
